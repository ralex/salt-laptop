...
{% set version = salt['pillar.get']('terraform:terraformer:version', salt['cmd.run'](python_shell=True, 'curl -sL "https://api.github.com/repos/GoogleCloudPlatform/terraformer/releases/latest" | jq -r ".tag_name"')) %}
